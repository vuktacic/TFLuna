/*
 * TFMiniPlus.h (forked copy for local fixes)
 *
 * Fork of senegalo/TFMiniPlus with defensive readCommandResponse fix.
 */
#ifndef TFMINIPLUS_FORK_H_
#define TFMINIPLUS_FORK_H_
